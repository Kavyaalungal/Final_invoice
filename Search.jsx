...
//         }
//       });
//       return response.data.refByDetails;
//     } catch (error) {
...
//       <Autocomplete
//         freeSolo
//         options={searchResults.map((result) => result.AhMst_pName)}
//         onInputChange={(event, newValue) => handleSearchChange('RefBy', newValue)}
//         onChange={(event, newValue) => setRefBy(newValue)} // Update the state with the selected value
//         renderInput={(params) => (
//           <TextField
//             {...params}
//             id="refBy"
